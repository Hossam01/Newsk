...
public class MainActivity extends AppCompatActivity implements Postions {
    ...
    @Override
    public void postion(Listitem item) {
        Intent detail = new Intent(getApplicationContext(), Detail.class);
        Bundle be = new Bundle();
        be.putSerializable(getString(R.string.path), item);
        detail.putExtras(be);
