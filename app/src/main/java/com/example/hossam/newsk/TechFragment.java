...
public class TechFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tech_fragment, container, false);

        final GridView gridView = (GridView) rootView.findViewById(R.id.gridView3);
        mSwipeRefreshLayout = (SwipeRefreshLayout) rootView.findViewById(R.id.swipe_refresh_layout3);
        arrayitems = new ArrayList<Listitem>();
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        final DatabaseReference myRef = database.getInstance().getReference().child("Tech");
        myRef.keepSynced(true);
        myRef.removeValue();

        String url = "https://api.myjson.com/bins/1bpg49";

        StringRequest posRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            @Override
        ...
        Volley.newRequestQueue(getActivity()).add(posRequest);
